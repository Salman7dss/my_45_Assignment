...
console.log("Test for equality with strings: 'Alice' == 'Alice'. I predict True.");
console.log(name == "Alice");
console.log("Test for inequality with strings: 'Alice' != 'Bob'. I predict True.");
console.log(name != "Bob");
// Tests using the lower case function
console.log("Test using the lower case function: 'Alice' in lower case == 'alice'. I predict True.");
...
console.log("Test using 'and' operator: age > 20 and age < 30. I predict True.");
...
console.log("Test whether 6 is not in the array [1, 2, 3, 4, 5]. I predict True.");
