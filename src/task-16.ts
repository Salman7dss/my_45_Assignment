...
let guestWhoCantMakeIt: string = "Isaac Newton";

// Identify the new guest to invite
let newGuest: string = "Galileo Galilei";
...
originalGuestList.unshift("Nikola Tesla");
...
originalGuestList.push("Stephen Hawking");
